...
* Friday, Jan. 17 &mdash; Assignment for Friday, Jan. 17: Before Friday's class, create and email me a notebook that solves all of the exercises from Sections 1-4 of *EIWL3* &mdash; We learned four more notebook features that greatly enhance readability: plain text cells, section cells, subsection cells, and comments in code &mdash; In class, we worked through a small but critical bit of physics, *[Position from Velocity &mdash; Theory](./demonstrations/PositionFromVelocity-Theory.nb.pdf)* &mdash; We manually filled out a [Position from Velocity Worksheet](./demonstrations/PositionFromVelocity-Worksheet.pdf) that demonstrates the theory we have developed so far the case of linearly increasing velocity (aka constant or uniform acceleration)
...
<img src="./illustrations/DisplayingConstantAcceleration.png" width="80%"/>
