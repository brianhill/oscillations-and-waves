...
### Week 4 &mdash; Forced Oscillation &mdash; Resonance &mdash; Damped Pendulum

* Tuesday, Feb. 4 &mdash; Problem Set 5: Do the Exercises from Sections 14 and 17 &mdash; Additionally, instead of turning in the exercises from Sections 15 and 16, explore Mathematica (as outlined in those two sections), and choose any topic that genuinely interests you on which to give a presentation &mdash; In-class: We will flesh out a little more of the [General Second-Order Runge-Kutta - Best Estimate of Average](./theory/GeneralRungeKutta2-BestEstimateOfAverage.nb.pdf) 
* Friday, Feb. 7 &mdash; Instead of a new Problem Set: Before class, have the *[General Second-Order Runge-Kutta - Forced Oscillation](./worksheets/05-GeneralRungeKutta2-ForcedOscillation.nb.pdf)* notebook working (don't turn it in) &mdash; In-class: We will use the notebook you finished before class to analyze resonance &mdash; Then we will transition from the damped harmonic oscillator to the damped pendulum &mdash; [Damped Oscillator and Damped Pendulum - Theory](./theory/DampedOscillatorAndDampedPendulum-Theory.nb.pdf) (Angle, Angular Velocity, Angular Acceleration, Approximate Theoretical Solution) &mdash; In-class: Complete [Damped Pendulum - Coordinates and Graphics](./worksheets/06-DampedPendulum-CoordinatesAndGraphics.nb.pdf) notebook
...
* Tuesday, Feb. 11 &mdash; Forced Pendulum &mdash; Phase Space &mdash; Chaos
