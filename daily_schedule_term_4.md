...
* Friday, Jan. 17 &mdash; Before class: create and email me a notebook that solves all of the exercises from Sections 1-4 of *EIWL3* &mdash; [PS01 Solution](./solutions/2025-01-17/Brian-PS01.nb.pdf) &mdash; We learned four more notebook features that greatly enhance readability: plain text cells, section cells, subsection cells, and comments in code &mdash; In class, we worked through a small but critical bit of physics, *[Position from Velocity &mdash; Theory](./demonstrations/PositionFromVelocity-Theory.nb.pdf)* &mdash; We manually filled out *[Position from Velocity - Constant Acceleration Worksheet](./worksheets/PositionFromVelocity-ConstantAccelerationWorksheet.pdf)* that demonstrates the theory we have developed so far for the case of linearly increasing velocity (aka constant acceleration or uniform acceleration)
