...
* Tuesday, March 18 &mdash; Problem Set 11: Do the Exercises from *EIWL3* Sections 29 and 30 &mdash; In-Class: Complete the *[Torsion Pendulum](./worksheets/11-TorsionPendulum.nb.pdf)* notebook, develop *[Coupled Torsion Pendula - Introduction to Second Derivatives](./theory/CoupledTorsionPendula-IntroductionToSecondDerivatives.nb.pdf),* and then complete the *[Coupled Torsion Pendula](./worksheets/12-CoupledTorsionPendula.nb.pdf)* notebook

#### Similarly, our thirteenth notebook (Torsion Waves) is a straightforward recapitulation of our ninth notebook (Many Harmonic Oscillators), but we will press on the initial conditions harder and learn how to get waves that are not jumbled to appear.
