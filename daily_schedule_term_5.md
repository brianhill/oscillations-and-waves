...
* Tuesday, April 15 &mdash; Problem Set 18: Do the exercises from *EIWL3* Sections 41 and 42  &mdash; Complete the [Rectangular Drumhead Redux](./worksheets/19-RectangularDrumheadRedux.nb.pdf) and [Circular Drumhead Redux](./worksheets/20-CircularDrumheadRedux.nb.pdf) notebooks &mdash; Presentation: Jeremy and Eli's presentation on population dynamics or other biology problem
